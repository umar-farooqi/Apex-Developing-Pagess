...
'       ASR.HRMIS_CODE,',
'       ASR.EMP_NAME,',
'       TO_CHAR(AFT.TR_DATE,''DD-MON-YYYY'') as TR_DATE,',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(190558048241889124)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(10959518862835944)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(10959621790835945)
,p_db_column_name=>'TRD_ID'
,p_display_order=>150
,p_column_identifier=>'R'
,p_column_label=>'Trd Id'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_use_as_row_header=>'N'
...
,p_sum_columns_on_break=>'TOTAL_DEBIT_AMOUNT:TOTAL_CREDIT_AMOUNT'
);
wwv_flow_imp_page.create_page_plug(
...
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'   ---AGRI SINGLE DATA INSERT KARWANA HO TO   ---------------',
'-- INSERT INTO EMP_API_DATA (HRMIS_CODE, EMP_NAME, REGION)',
'-- SELECT ',
'--        jt.hrmis_code,',
'--        jt.name,',
'--        jt.region',
...
'--       SELECT 1',
'--       FROM EMP_API_DATA e',
'--       WHERE e.HRMIS_CODE = jt.hrmis_code',
'-- );',
'',
'',
'',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'case_sensitive', 'N',
  'fetch_on_search', 'N',
  'manual_entries_item', 'P855_SUB_DEPARTMENT_1',
  'match_type', 'CONTAINS',
  'min_chars', '0',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'case_sensitive', 'N',
  'fetch_on_search', 'N',
  'manual_entries_item', 'P855_SUB_ACC_TYPE_1',
  'match_type', 'CONTAINS',
  'min_chars', '0',
  'multi_selection', 'Y')).to_clob
,p_multi_value_type=>'SEPARATED'
...
'SELECT TO_CHAR(TO_DATE(''01-JUL-'' || (TO_CHAR(SYSDATE, ''YYYY'') - 1),''DD-MON-YYYY''),''DD-MON-YYYY'') AS START_DATE FROM DUAL;',
''))
